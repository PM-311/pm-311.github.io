...
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| **Tarea 1** | [pdf](assets/assignments/homework1.pdf), [código inicial](https://colab.research.google.com/github/PM-311/laboratorios/blob/main/1_errores.ipynb) (crear una copia en tu Drive) | 1 de septiembre (publicada), vence el 21 de septiembre |
{% comment %}
